...
| [Core skills](./v0/plugins/11agi-core/README.md) | 8 | Building, auditing, and maintaining other skills and the plugins that package them, plus markdown compression, repository reverse engineering, report and web styleguides, a pragmatic communication register, and a blunt read-only critique |
...
v0/
  ...
  plugins/
    ...
    11agi-core/          8 skill-authoring, packaging, compression, reverse-engineering, styleguide, and communication-register skills under skills/
