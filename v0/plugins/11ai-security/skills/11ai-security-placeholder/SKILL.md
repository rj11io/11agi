---
name: 11agi-security-placeholder
description: "A stand-in for the 11agi-security plugin while its real skills are built: threat modeling, secure-coding review, and secrets handling. It runs no checks itself. Use it to learn what this plugin is for, and read the 11agi-audit plugin instead if you want a security check that works today."
---

# 11agi Security Placeholder

## What this skill does right now

Nothing scans, checks, or reports here yet. This skill is a sign-post: it tells
you what the `11agi-security` plugin is for, and points you to the security
skill that already works, [`11agi-audit`](../../../11agi-audit/README.md), so
you are not stuck waiting on this one.

## What "11agi-security" will hold once it is built
...
1. [`11agi-audit`](../../../11agi-audit/README.md) — the plugin already doing
...
every other 11agi plugin does it.
