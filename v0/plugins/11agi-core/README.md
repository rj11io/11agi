...
| [`11agi-pragmatic`](./skills/11agi-pragmatic/SKILL.md) | Answering in a terse, evidence-preserving register: short lines, examples where applicable, a fix beside every problem, read-only planning, no destructive actions without an explicit instruction, and a copyable detailed conventional commit message after repo work |
