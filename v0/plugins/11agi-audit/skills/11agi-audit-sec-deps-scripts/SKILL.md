---
name: 11agi-audit-sec-deps-scripts
...
# 11agi Audit Security Dependency Scan
...
python3 scripts/scan_dependencies.py /path/to/project --format json --output /tmp/11agi-dependency-inventory.json
```
...
```text
11agi-audit-sec-deps-scripts-report-YYYYMMDDTHHMMSSZ.md
```

Generate the datetime in UTC at write time; for example,
`11agi-audit-sec-deps-scripts-report-20260718T143052Z.md`. Resolve the project root
...
```markdown
_Security scan by [11agi-audit-sec-deps-scripts](https://agi.rj11.io/skills/11agi-audit-sec-deps-scripts)._
```
