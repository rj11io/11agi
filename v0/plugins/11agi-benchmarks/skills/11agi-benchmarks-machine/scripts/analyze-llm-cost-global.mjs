...
const REPORT_SIGNATURE = "_AI benchmarks and analysis by [11agi-benchmarks-machine](https://agi.rj11.io/skills/11agi-benchmarks-machine)._"
  ...
  for (let index = 0; index < lines.length;) {
    ...
    if (signature) {
      ...
      const signatureHtml = inlineHtml(line).replace(
        '<a href="https://agi.rj11.io/skills/11agi-benchmarks-machine">',
        '<a href="https://agi.rj11.io/skills/11agi-benchmarks-machine" target="_blank" rel="noopener noreferrer">',
      )
