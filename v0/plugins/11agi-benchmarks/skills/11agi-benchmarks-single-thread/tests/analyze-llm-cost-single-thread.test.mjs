...
const fixtureRoot = mkdtempSync(join(tmpdir(), "11agi-benchmarks-single-thread-"))
...
try {
  ...
  assert.match(basename(summary.outputDirectory), /^11agi-benchmarks-single-thread-reports-\d{4}-\d{2}-\d{2}T/)
  assert.match(basename(summary.markdownReport), /^11agi-benchmarks-single-thread-\d{4}-\d{2}-\d{2}T.*\.md$/)
  ...
  assert.equal(summaryDataset.generator.skill, "11agi-benchmarks-single-thread")
  ...
  assert.match(markdown, /^# AI benchmarks and analysis: Single-Thread Report\n\n_powered by \[11agi-benchmarks-single-thread\]\(https:\/\/agi\.rj11\.io\/skills\/11agi-benchmarks-single-thread\)\._\n\n/)
  ...
  assert.ok(markdown.endsWith("_AI benchmarks and analysis by [11agi-benchmarks-single-thread](https://agi.rj11.io/skills/11agi-benchmarks-single-thread)._\n"))
  ...
  assert.match(html, /<h1>AI benchmarks and analysis: Single-Thread Report <span class="powered-by"><a href="https:\/\/agi\.rj11\.io\/skills\/11agi-benchmarks-single-thread" target="_blank" rel="noopener noreferrer">powered by 11agi-benchmarks-single-thread<\/a><\/span><\/h1>/)
  assert.equal((html.match(/powered by 11agi-benchmarks-single-thread/g) ?? []).length, 1)
  ...
  assert.match(html, /<a href="https:\/\/agi\.rj11\.io\/skills\/11agi-benchmarks-single-thread" target="_blank" rel="noopener noreferrer">11agi-benchmarks-single-thread<\/a>/)
  ...
  assert.match(unpricedHtml, /<a href="https:\/\/agi\.rj11\.io\/skills\/11agi-benchmarks-pricing-update" target="_blank" rel="noopener noreferrer">11agi-benchmarks-pricing-update<\/a>/)
