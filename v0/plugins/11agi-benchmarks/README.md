...
| Skill | Use it for |
| --- | --- |
| [`11agi-benchmarks-machine`](./skills/11agi-benchmarks-machine/SKILL.md) | Reporting machine-wide LLM usage under `~/Desktop/11agi-benchmarks-machine-reports/11agi-benchmarks-machine-reports-{datetime}` |
| [`11agi-benchmarks-project`](./skills/11agi-benchmarks-project/SKILL.md) | Analyzing project-attributed LLM usage and writing matching reports under `<current-thread-folder>/11agi-benchmarks-project-reports/11agi-benchmarks-project-reports-{datetime}` |
| [`11agi-benchmarks-single-thread`](./skills/11agi-benchmarks-single-thread/SKILL.md) | Analyzing the active Codex thread or one exact thread selector under `<current-thread-folder>/11agi-benchmarks-single-thread-reports/11agi-benchmarks-single-thread-reports-{datetime}` |
| [`11agi-benchmarks-pricing-update`](./skills/11agi-benchmarks-pricing-update/SKILL.md) | Verifying official provider prices, updating the canonical catalog, and synchronizing all three reporting skills |
| [`11agi-benchmarks-faq`](./skills/11agi-benchmarks-faq/SKILL.md) | Answering questions about how these skills behave, what report sections mean, and which skill to run |
