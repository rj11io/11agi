...
| Skill | Use it for |
| --- | --- |
| [`11agi-ai-analytics-machine`](./skills/11agi-ai-analytics-machine/SKILL.md) | Reporting machine-wide LLM usage under `~/Desktop/11agi-ai-analytics-machine-reports/11agi-ai-analytics-machine-reports-{datetime}` |
| [`11agi-ai-analytics-project`](./skills/11agi-ai-analytics-project/SKILL.md) | Analyzing project-attributed LLM usage and writing matching reports under `<current-thread-folder>/11agi-ai-analytics-project-reports/11agi-ai-analytics-project-reports-{datetime}` |
| [`11agi-ai-analytics-single-thread`](./skills/11agi-ai-analytics-single-thread/SKILL.md) | Analyzing the active Codex thread or one exact thread selector under `<current-thread-folder>/11agi-ai-analytics-single-thread-reports/11agi-ai-analytics-single-thread-reports-{datetime}` |
| [`11agi-ai-analytics-pricing-update`](./skills/11agi-ai-analytics-pricing-update/SKILL.md) | Verifying official provider prices, updating the canonical catalog, and synchronizing all three reporting skills |
| [`11agi-ai-analytics-faq`](./skills/11agi-ai-analytics-faq/SKILL.md) | Answering questions about how these skills behave, what report sections mean, and which skill to run |
