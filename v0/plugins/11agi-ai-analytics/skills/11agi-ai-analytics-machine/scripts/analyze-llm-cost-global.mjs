...
const reportSkillName = "11agi-ai-analytics-machine"
const reportTitle = "AI benchmarks and analysis: Machine Report"
const reportSkillUrl = `https://agi.rj11.io/skills/${reportSkillName}`
const pricingUpdateSkillUrl = "https://agi.rj11.io/skills/11agi-ai-analytics-pricing-update"
const reportPoweredBy = `_powered by [${reportSkillName}](${reportSkillUrl})._`
const reportName = `${reportSkillName}-${filenameTimestamp}`
const reportPackageName = `11agi-ai-analytics-machine-reports-${filenameTimestamp}`
...
const outputDir = resolve(explicitOutputDir ?? join(homedir(), "Desktop", "11agi-ai-analytics-machine-reports", reportPackageName))
...
const REPORT_SIGNATURE = "_AI benchmarks and analysis by [11agi-ai-analytics-machine](https://agi.rj11.io/skills/11agi-ai-analytics-machine)._"
...
function report({ threads, stats, malformed, duplicateIds }) {
  ...
  const lines = [
    ...
    ...(actionableUnmatched.length ? [
      ...
      "",
      `**Pricing update required:** Known-cost totals exclude the models above. Run [11agi-ai-analytics-pricing-update](${pricingUpdateSkillUrl}) to verify official rates and update the bundled catalog, then regenerate this report.`,
      "",
    ] : []),
  ...
  for (let index = 0; index < lines.length;) {
    ...
    if (signature) {
      ...
      const signatureHtml = inlineHtml(line).replace(
        '<a href="https://agi.rj11.io/skills/11agi-ai-analytics-machine">',
        '<a href="https://agi.rj11.io/skills/11agi-ai-analytics-machine" target="_blank" rel="noopener noreferrer">',
      )
