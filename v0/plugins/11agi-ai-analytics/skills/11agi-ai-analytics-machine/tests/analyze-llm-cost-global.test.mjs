...
const fixtureRoot = mkdtempSync(join(tmpdir(), "11agi-ai-analytics-machine-"))
...
try {
  ...
  assert.equal(summaryDataset.generator.skill, "11agi-ai-analytics-machine")
  ...
  assert.ok(markdown.endsWith("_AI benchmarks and analysis by [11agi-ai-analytics-machine](https://agi.rj11.io/skills/11agi-ai-analytics-machine)._\n"))
  ...
  assert.match(html, /<h1>AI benchmarks and analysis: Machine Report <span class="powered-by"><a href="https:\/\/agi\.rj11\.io\/skills\/11agi-ai-analytics-machine" target="_blank" rel="noopener noreferrer">powered by 11agi-ai-analytics-machine<\/a><\/span><\/h1>/)
  assert.equal((html.match(/powered by 11agi-ai-analytics-machine/g) ?? []).length, 1)
  ...
  assert.match(html, /<a href="https:\/\/agi\.rj11\.io\/skills\/11agi-ai-analytics-machine" target="_blank" rel="noopener noreferrer">11agi-ai-analytics-machine<\/a>/)
  ...
  const reportsRoot = join(fakeDesktop, "11agi-ai-analytics-machine-reports")
  assert.equal(dirname(defaultSummary.outputDirectory), reportsRoot)
  assert.match(basename(defaultSummary.outputDirectory), /^11agi-ai-analytics-machine-reports-\d{4}-\d{2}-\d{2}T/)
  ...
  assert.match(basename(defaultSummary.markdownReport), /^11agi-ai-analytics-machine-\d{4}-\d{2}-\d{2}T.*\.md$/)
  ...
  assert.match(legacyMarkdown, /Known-cost totals exclude the models above\. Run \[11agi-ai-analytics-pricing-update\]\(https:\/\/agi\.rj11\.io\/skills\/11agi-ai-analytics-pricing-update\)/)
  assert.match(legacyHtml, /<a href="https:\/\/agi\.rj11\.io\/skills\/11agi-ai-analytics-pricing-update" target="_blank" rel="noopener noreferrer">11agi-ai-analytics-pricing-update<\/a>/)
