---
name: 11agi-ai-analytics-machine
...
```text
~/Desktop/11agi-ai-analytics-machine-reports/
└── 11agi-ai-analytics-machine-reports-{datetime}/
    ├── 11agi-ai-analytics-machine-{datetime}.md
    ├── 11agi-ai-analytics-machine-{datetime}.html
    └── 11agi-ai-analytics-machine-{datetime}.json
```
...
1. Confirm that the request is machine-wide. Use `~/Desktop/11agi-ai-analytics-machine-reports/11agi-ai-analytics-machine-reports-{datetime}` for default output and use home overrides only for deterministic fixtures or an intentionally restricted scan.
...
- confirm `~/Desktop/11agi-ai-analytics-machine-reports/11agi-ai-analytics-machine-reports-{datetime}` exists unless the user requested an override;
- confirm the timestamped package contains same-named `.md` and `.html` reports;
- confirm the Markdown report places the linked `powered by 11agi-ai-analytics-machine` attribution immediately below its H1;
- confirm the HTML main title includes the smaller inline linked text `powered by 11agi-ai-analytics-machine` and that its link safely opens in a new tab;
