...
const fixtureRoot = mkdtempSync(join(tmpdir(), "11agi-ai-analytics-project-"))
...
try {
  ...
  assert.ok(markdown.endsWith("_AI benchmarks and analysis by [11agi-ai-analytics-project](https://agi.rj11.io/skills/11agi-ai-analytics-project)._\n"))
  ...
  assert.match(html, /<h1>AI benchmarks and analysis: Project Report <span class="powered-by"><a href="https:\/\/agi\.rj11\.io\/skills\/11agi-ai-analytics-project" target="_blank" rel="noopener noreferrer">powered by 11agi-ai-analytics-project<\/a><\/span><\/h1>/)
  assert.equal((html.match(/powered by 11agi-ai-analytics-project/g) ?? []).length, 1)
  ...
  assert.match(html, /<a href="https:\/\/agi\.rj11\.io\/skills\/11agi-ai-analytics-project" target="_blank" rel="noopener noreferrer">11agi-ai-analytics-project<\/a>/)
  ...
  assert.match(unmatchedHtml, /<a href="https:\/\/agi\.rj11\.io\/skills\/11agi-ai-analytics-pricing-update" target="_blank" rel="noopener noreferrer">11agi-ai-analytics-pricing-update<\/a>/)
  ...
  const reportsRoot = join(resolvedThreadRoot, "11agi-ai-analytics-project-reports")
  ...
  assert.match(basename(defaultReportDir), /^11agi-ai-analytics-project-reports-\d{4}-\d{2}-\d{2}T/)
  ...
  assert.match(basename(defaultSummary.markdownReport), /^11agi-ai-analytics-project-\d{4}-\d{2}-\d{2}T.*\.md$/)
  ...
  assert.equal(genericDataset.generator.skill, "11agi-ai-analytics-project")
