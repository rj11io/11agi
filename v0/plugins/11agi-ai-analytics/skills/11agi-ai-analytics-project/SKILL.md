---
name: 11agi-ai-analytics-project
...
```text
<thread-folder>/11agi-ai-analytics-project-reports/
└── 11agi-ai-analytics-project-reports-{datetime}/
    ├── 11agi-ai-analytics-project-{datetime}.md
    ├── 11agi-ai-analytics-project-{datetime}.html
    └── 11agi-ai-analytics-project-{datetime}.json
```
...
4. Leave unmatched models unpriced and make the report direct the user to [`11agi-ai-analytics-pricing-update`](https://agi.rj11.io/skills/11agi-ai-analytics-pricing-update). Do not research, inject, or persist rates from this reporting skill.
...
- confirm `<thread-folder>/11agi-ai-analytics-project-reports/11agi-ai-analytics-project-reports-{datetime}` exists and contains matching `11agi-ai-analytics-project-{datetime}.md`, `.html`, and `.json` files;
- confirm the Markdown report places the linked `powered by 11agi-ai-analytics-project` attribution immediately below its H1;
- confirm the HTML main title includes the smaller inline linked text `powered by 11agi-ai-analytics-project` and that its link safely opens in a new tab;
