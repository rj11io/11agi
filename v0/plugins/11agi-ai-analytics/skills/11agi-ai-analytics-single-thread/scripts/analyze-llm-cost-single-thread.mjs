...
if (argv.includes("--help")) {
  console.log("usage: node analyze-llm-cost-single-thread.mjs [root-folder] [--thread id-or-source] [--output report.md] [--codex-home dir] [--claude-home dir] [--claude-desktop-home dir] [--cowork-home dir] [--gemini-home dir] [--cline-tasks dir] [--roo-tasks dir] [--opencode-db file] [--project-only] [--from-data data.json]")
...
const reportSkillName = "11agi-ai-analytics-single-thread"
