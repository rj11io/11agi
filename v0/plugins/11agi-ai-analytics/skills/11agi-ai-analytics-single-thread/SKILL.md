---
name: 11agi-ai-analytics-single-thread
...
```text
<thread-folder>/11agi-ai-analytics-single-thread-reports/
└── 11agi-ai-analytics-single-thread-reports-{datetime}/
    ├── 11agi-ai-analytics-single-thread-{datetime}.md
    ├── 11agi-ai-analytics-single-thread-{datetime}.html
    └── 11agi-ai-analytics-single-thread-{datetime}.json
```
...
```markdown
_AI benchmarks and analysis by [11agi-ai-analytics-single-thread](https://agi.rj11.io/skills/11agi-ai-analytics-single-thread)._
```
...
- confirm the Markdown report places the linked `powered by 11agi-ai-analytics-single-thread` attribution immediately below its H1;
- confirm the HTML main title includes the smaller inline linked text `powered by 11agi-ai-analytics-single-thread` and that its link safely opens in a new tab;
