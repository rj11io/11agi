---
name: 11agi-ai-analytics-pricing-update
...
5. Synchronize the three bundled report catalogs:
   ...
   ```bash
   node 11agi-ai-analytics-pricing-update/scripts/sync-pricing-catalog.mjs --write
   ```

6. Validate catalog structure and synchronization:

   ```bash
   node 11agi-ai-analytics-pricing-update/scripts/sync-pricing-catalog.mjs
   ```
