...
const reportCatalogs = [
  resolve(skillsRoot, "11agi-ai-analytics-project/references/pricing.json"),
  resolve(skillsRoot, "11agi-ai-analytics-machine/references/pricing.json"),
  resolve(skillsRoot, "11agi-ai-analytics-single-thread/references/pricing.json"),
]
const reportResolvers = [
  resolve(skillsRoot, "11agi-ai-analytics-project/scripts/pricing-history.mjs"),
  resolve(skillsRoot, "11agi-ai-analytics-machine/scripts/pricing-history.mjs"),
  resolve(skillsRoot, "11agi-ai-analytics-single-thread/scripts/pricing-history.mjs"),
]
...
if (divergent.length) {
  ...
  console.error("Run: node 11agi-ai-analytics-pricing-update/scripts/sync-pricing-catalog.mjs --write")
  process.exit(1)
}
