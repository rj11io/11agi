...
try {
  ...
  assert.match(markdown, /^# AI benchmarks and analysis: Machine Report\n\n_powered by \[11agi-benchmarks-machine\]\(https:\/\/ai\.rj11\.io\/skills\/11agi-benchmarks-machine\)\._\n\n/)
  ...
  assert.ok(markdown.endsWith("_AI benchmarks and analysis by [11agi-benchmarks-machine](https://ai.rj11.io/skills/11agi-benchmarks-machine)._\n"))
  ...
  assert.match(html, /<h1>AI benchmarks and analysis: Machine Report <span class="powered-by"><a href="https:\/\/ai\.rj11\.io\/skills\/11agi-benchmarks-machine" target="_blank" rel="noopener noreferrer">powered by 11agi-benchmarks-machine<\/a><\/span><\/h1>/)
  ...
  assert.match(html, /<a href="https:\/\/ai\.rj11\.io\/skills\/11agi-benchmarks-machine" target="_blank" rel="noopener noreferrer">11agi-benchmarks-machine<\/a>/)
  ...
  assert.match(legacyMarkdown, /Known-cost totals exclude the models above\. Run \[11agi-benchmarks-pricing-update\]\(https:\/\/ai\.rj11\.io\/skills\/11agi-benchmarks-pricing-update\)/)
  assert.match(legacyHtml, /<a href="https:\/\/ai\.rj11\.io\/skills\/11agi-benchmarks-pricing-update" target="_blank" rel="noopener noreferrer">11agi-benchmarks-pricing-update<\/a>/)
