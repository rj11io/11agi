...
try {
  ...
  assert.match(markdown, /^# AI benchmarks and analysis: Project Report\n\n_powered by \[11agi-benchmarks-project\]\(https:\/\/ai\.rj11\.io\/skills\/11agi-benchmarks-project\)\._\n\n/)
  ...
  assert.ok(markdown.endsWith("_AI benchmarks and analysis by [11agi-benchmarks-project](https://ai.rj11.io/skills/11agi-benchmarks-project)._\n"))
  ...
  assert.match(html, /<h1>AI benchmarks and analysis: Project Report <span class="powered-by"><a href="https:\/\/ai\.rj11\.io\/skills\/11agi-benchmarks-project" target="_blank" rel="noopener noreferrer">powered by 11agi-benchmarks-project<\/a><\/span><\/h1>/)
  ...
  assert.match(html, /<a href="https:\/\/ai\.rj11\.io\/skills\/11agi-benchmarks-project" target="_blank" rel="noopener noreferrer">11agi-benchmarks-project<\/a>/)
  ...
  assert.match(unmatchedHtml, /<a href="https:\/\/ai\.rj11\.io\/skills\/11agi-benchmarks-pricing-update" target="_blank" rel="noopener noreferrer">11agi-benchmarks-pricing-update<\/a>/)
