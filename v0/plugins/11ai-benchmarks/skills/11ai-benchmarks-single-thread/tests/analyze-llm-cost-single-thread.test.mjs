...
try {
  ...
  assert.match(markdown, /^# AI benchmarks and analysis: Single-Thread Report\n\n_powered by \[11agi-benchmarks-single-thread\]\(https:\/\/ai\.rj11\.io\/skills\/11agi-benchmarks-single-thread\)\._\n\n/)
  ...
  assert.ok(markdown.endsWith("_AI benchmarks and analysis by [11agi-benchmarks-single-thread](https://ai.rj11.io/skills/11agi-benchmarks-single-thread)._\n"))
  ...
  assert.match(html, /<h1>AI benchmarks and analysis: Single-Thread Report <span class="powered-by"><a href="https:\/\/ai\.rj11\.io\/skills\/11agi-benchmarks-single-thread" target="_blank" rel="noopener noreferrer">powered by 11agi-benchmarks-single-thread<\/a><\/span><\/h1>/)
  ...
  assert.match(html, /<a href="https:\/\/ai\.rj11\.io\/skills\/11agi-benchmarks-single-thread" target="_blank" rel="noopener noreferrer">11agi-benchmarks-single-thread<\/a>/)
  ...
  assert.match(unpricedHtml, /<a href="https:\/\/ai\.rj11\.io\/skills\/11agi-benchmarks-pricing-update" target="_blank" rel="noopener noreferrer">11agi-benchmarks-pricing-update<\/a>/)
