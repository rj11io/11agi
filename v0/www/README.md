...
The Next.js 16 application for the 11agi project site at https://agi.rj11.io/. It turns the repository's `SKILL.md` files into a searchable catalog with plugin and skill detail pages.
...
No environment variables are currently required. The app reads skill content from the sibling `plugins/` directory and the package version from the repository root. Press `d` outside a form field to switch between light and dark themes.
